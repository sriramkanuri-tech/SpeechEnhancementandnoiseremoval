...
from spectral_noise_reduction_v43 import SpectralNoiseReducer


INPUT_FILE = "../output/test_original.wav"
OUTPUT_FILE = "../output/test_enhanced_v43.wav"


print("=" * 60)
print("PHASE 2 - V4.3 SPEECH ENHANCEMENT")
print("=" * 60)
...
print("  - Frequency-dependent suppression")
print("  - Speech-frequency protection")
print("  - Strong speech-component protection")
