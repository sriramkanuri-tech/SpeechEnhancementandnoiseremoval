...
class SpeechEnhancementApp:
    ...
    def build_ui(self):
        ...
        tk.Label(
            header,
            text="Real-Time Speech Enhancement • V4.1",
            font=(
                "DejaVu Sans",
                11
            ),
    ...
    def create_microphone_card(
        ...
        tk.Label(
            card,
            text=(
                "Physical microphone used by the application"
            ),
            font=(
                "DejaVu Sans",
                9
    ...
    def build_test_mode(self):
        ...
        tk.Label(
            output_card,
            text=(
                "Speaker or headphones used for playback"
            ),
            font=(
                "DejaVu Sans",
                9
    ...
    def record_test_worker(
        ...
        try:
            ...
            #
            # IMPORTANT:
            # Your actual V4.1 reducer accepts only
            # the audio argument.
            # ------------------------------------------------
    ...
    def start_meeting(self):
        ...
        self.meeting_info.config(
            text=(
                "App Microphone: Selected microphone\n"
                "Output: System Default Speaker / Headphones\n"
                "Processing: V4.1\n"
                "Recording: OFF\n"
                "Status: Keep quiet for 2 seconds..."
            )
        )
    ...
    def meeting_worker(
        ...
        try:
            ...
            # Your actual V4.1 function takes
            # calibration audio only.

            self.live_reducer.initialize_noise(
                calibration
            )
